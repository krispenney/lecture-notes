...
- Alg
  ...
  2. For each k-th element after, keep with probability of $$\frac{s}{k}$$
    - Randomly drop an existing element if you decide to keep
- Probability of an element being discarded: $$\frac{s}{k} * \frac{1}{k}$$
- Probability of survival: $$\frac{s}{k}$$ -> 1 - prob of discarded
